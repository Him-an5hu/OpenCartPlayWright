...
import { LogoutPage } from '../pages/LogoutPage'; // Import LogoutPage if needed
...
export class MyAccountPage {
    ...
    async clickLogout(): Promise<LogoutPage> {
        try 
        {
            ...
            return new LogoutPage(this.page); // meaning ? It will return the instance of LogoutPage class to the caller method which is clickLogout() method in MyAccountPage class. So, when we call clickLogout() method from test method it will return the instance of LogoutPage class and we can use that instance to call the methods of LogoutPage class.
        } catch (error) {

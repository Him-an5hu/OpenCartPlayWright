...
- Name: LoginDataDriven.spec.ts >> Login Test with JSON Data: Login with valid credentials @datadriven
        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: abc@example.com
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: admin@123
...
```ts
  ...
  16 | {
  17 |    test(`Login Test with JSON Data: ${data.testCaseName} @datadriven`, async({page})=>{
  18 |     

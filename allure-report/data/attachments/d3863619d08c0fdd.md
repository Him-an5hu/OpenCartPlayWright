...
```ts
  ...
  37 | await registrationPage.setEmail(RandomDataUtils.getEmail());
  ...
  48 | console.log(confirationMSG);
> 49 | expect(confirationMSG).toContain('Your Account Has Been Created!')
     |                        ^ TypeError: received is not iterable
  50 | 
